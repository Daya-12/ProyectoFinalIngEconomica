...
@Component({
  selector: 'app-anualidad-perpetua',
  templateUrl: './anualidad-perpetua.component.html',
  styleUrls: ['./anualidad-perpetua.component.css']
})
export class AnualidadPerpetuaComponent {
    ...
    if (!this.checked) {
      ...
      /*switch (this.tipoValor) {
        default:
          ...
          valor = this.monto * ((((1+interes)**this.periodos)-1) / interes);
          break;
        case 'valor-presente':
          this.nombreValor = 'presente';
          valor = this.monto * ((1-((1+interes)**-this.periodos)) / interes);
          break;
      }*/
      valor = this.monto / interes;
