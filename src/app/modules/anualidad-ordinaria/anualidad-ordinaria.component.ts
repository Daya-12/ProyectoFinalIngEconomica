...
@Component({
  selector: 'app-anualidad-ordinaria',
  templateUrl: './anualidad-ordinaria.component.html',
  styleUrls: ['./anualidad-ordinaria.component.css']
})
export class AnualidadOrdinariaComponent {
